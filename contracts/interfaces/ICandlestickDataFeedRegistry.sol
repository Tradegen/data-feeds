...
interface ICandlestickDataFeedRegistry {
    ...
    */
    function getCurrentPrice(string memory _asset) external view returns (uint256);
    ...
    */
    function getPriceAt(string memory _asset, uint256 _index) external view returns (uint256);
    ...
    */
    function getCurrentCandlestick(string memory _asset) external view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256);
    ...
    * @return (uint256, uint256, uint256, uint256, uint256, uint256, uint256) The candlestick index, high price, low price, open price, close price, volume, and starting timestamp.
    */
    function getCandlestickAt(string memory _asset, uint256 _index) external view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256);
    ...
    */
    function getDataFeedInfo(string memory _asset) external view returns (address, string memory, address, uint256, uint256);
    ...
    * @param _asset Symbol of the asset.
    */
    function getDataFeedAddress(string memory _asset) external view returns (address);
    ...
    * @param _asset Symbol of the asset.
    */
    function lastUpdated(string memory _asset) external view returns (uint256);
    ...
    * @param _asset Symbol of the asset.
    */
    function getDataFeedStatus(string memory _asset) external view returns (uint256);
    ...
    */
    function aggregateCandlesticks(string memory _asset, uint256 _numberOfCandlesticks) external view returns (uint256, uint256, uint256, uint256, uint256, uint256);
    ...
    */
    function hasDataFeed(string memory _asset) external view returns (bool);
    ...
    */
    function registerDataFeed(string memory _asset, address _dedicatedDataProvider) external;
}